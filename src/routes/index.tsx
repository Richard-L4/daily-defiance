...
const I18N = {
  en: {
    ...
    remove: "Remove",
    clearFavorite: "Clear Favourite",
    clearFavorites: "Clear Favourites",
    clearSelected: "Press to clear selected",
  ...
  es: {
    ...
    remove: "Quitar",
    clearFavorite: "Borrar favorito",
    clearFavorites: "Borrar favoritos",
    clearSelected: "Pulsa para borrar seleccionados",
